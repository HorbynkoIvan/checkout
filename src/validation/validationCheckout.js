import {checkValidPhoneCode} from "../helpers/helpers";
...
export const validationCheckout = (values) => {
    ...
    const validPhone = values.phone && values.phone.replace(/[^0-9]/g, '').length === 12;
    ...
    } else if (validPhone && !checkValidPhoneCode(values.phone)) {
        errors.phone = {incorrectPhone: true};
    }
